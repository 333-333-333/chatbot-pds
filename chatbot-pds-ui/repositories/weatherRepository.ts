...
import { Condition, LocationCoordinates, TimeOfDay, WeatherData } from "@/interfaces";
...
export class WeatherRepository {
    ...
    async getCurrentWeather(location: LocationCoordinates): Promise<WeatherData | null> {
